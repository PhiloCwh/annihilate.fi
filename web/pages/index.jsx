...
const Home = () => {
  ...
  const [TokenOutAddress, setTokenOutAdress] = useState('0x56464E802A9520894A5d9DC445fc5f637F30EdBc')
  const [TokenOutName, setTokenOutName] = useState('0x56464E802A9520894A5d9DC445fc5f637F30EdBc')
  ...
  const cacal = async () => {
    ...
    if (TokenOutAddress[0] == '-') {
      ...
      let res = await ammContract.calSwapTokenOutAmount(TokenInAddress, TokenOutAddress, amountIn).catch(e => {
        console.log(e);
      })
      setOutAmount(res?.toString())
    }
